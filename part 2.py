...
while True :
    ...
    def horizontal_histogram():
        ...
        print(f"Progress {Prog_count}  : " + "*" * Prog_count)  #https://www.programiz.com/python-programming/methods/string/format
...
count_array = [Prog_count, Trail_count, Excl_count, Retr_count]
max = 0
